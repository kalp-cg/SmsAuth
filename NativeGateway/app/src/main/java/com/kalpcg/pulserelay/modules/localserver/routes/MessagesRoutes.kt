...
import io.ktor.server.routing.route
import com.kalpcg.pulserelay.data.entities.MessageWithRecipients
...
import com.kalpcg.pulserelay.helpers.DateTimeParser
...
import com.kalpcg.pulserelay.modules.localserver.domain.GetMessageResponse
import com.kalpcg.pulserelay.modules.localserver.domain.PostMessageRequest
import com.kalpcg.pulserelay.modules.localserver.domain.PostMessageResponse
import com.kalpcg.pulserelay.modules.localserver.domain.PostMessagesInboxExportRequest
import com.kalpcg.pulserelay.modules.messages.MessagesService
import com.kalpcg.pulserelay.modules.messages.data.Message
import com.kalpcg.pulserelay.modules.messages.data.SendParams
import com.kalpcg.pulserelay.modules.messages.data.SendRequest
...
class MessagesRoutes(
            ...
            call.respond(
                ...
                PostMessageResponse(
                    ...
                    recipients = request.phoneNumbers.map {
                        com.kalpcg.pulserelay.modules.localserver.domain.Message.Recipient(
                            it,
    ...
    private fun MessageWithRecipients.toDomain(deviceId: String) =
        com.kalpcg.pulserelay.modules.localserver.domain.Message(
            id = message.id,
            deviceId = deviceId,
            state = message.state,
            isHashed = false,
