package com.kalpcg.pulserelay.data.dao
...
import com.kalpcg.pulserelay.data.entities.MessageState
import com.kalpcg.pulserelay.data.entities.MessageWithRecipients
import com.kalpcg.pulserelay.data.entities.MessagesStats
import com.kalpcg.pulserelay.data.entities.MessagesTotals
import com.kalpcg.pulserelay.data.entities.RecipientState
...
interface MessagesDao {
    ...
    fun _insertRecipientStatesByMessage(
        messageId: String,
        state: com.kalpcg.pulserelay.domain.ProcessingState
    )
    ...
    fun _updateMessageState(id: String, state: com.kalpcg.pulserelay.domain.ProcessingState)

    fun updateMessageState(id: String, state: com.kalpcg.pulserelay.domain.ProcessingState) {
    ...
    fun setMessageProcessed(id: String) {
        ...
        _insertMessageState(
            MessageState(
                id,
                com.kalpcg.pulserelay.domain.ProcessingState.Processed,
                System.currentTimeMillis()
            )
        )
    }
