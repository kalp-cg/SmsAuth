...
import com.kalpcg.pulserelay.databinding.FragmentMessageDetailsBinding
import com.kalpcg.pulserelay.modules.messages.vm.MessageDetailsViewModel
import com.kalpcg.pulserelay.ui.adapters.MessageRecipientsAdapter
...
class MessageDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.message.observe(viewLifecycleOwner) {
            ...
            val contentStr = it.message.content.toString()
            val maskedContent = contentStr.replace(Regex("\\b\\d{6}\\b"), "******")
            binding.textMessage.text = maskedContent
