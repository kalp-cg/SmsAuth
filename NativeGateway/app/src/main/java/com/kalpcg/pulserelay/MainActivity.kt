...
import com.kalpcg.pulserelay.databinding.ActivityMainBinding
import com.kalpcg.pulserelay.helpers.SettingsHelper
import com.kalpcg.pulserelay.modules.orchestrator.OrchestratorService
import com.kalpcg.pulserelay.ui.HolderFragment
import com.kalpcg.pulserelay.ui.HomeFragment
import com.kalpcg.pulserelay.ui.SettingsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (settingsHelper.autostart) {
            runCatching { orchestratorSvc.start(this, true) }
        }
    }
